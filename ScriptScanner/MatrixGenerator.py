    ...
    if fila != 0:
        ...
        for col in range(int(-1920 / 2), int(1920 / 2) + 1):
            if col != 0:
                ...
                aux_x.append(
                    np.around(interseccion_recta_plano(recta, plano), 3).tolist()[0]
                )
                aux_y.append(
                    np.around(interseccion_recta_plano(recta, plano), 3).tolist()[1]
                )
                aux_z.append(
                    np.around(interseccion_recta_plano(recta, plano), 3).tolist()[2]
                )
