    ...
    def CONECTAR_ARDUINO(self):
        ...
        try:
            ...
            if self.arduino.is_open:
                ...
                self.SET_MICROPASOS(microstep=6)

                return True
        except serial.serialutil.SerialException:
            print("ERROR !!! ARDUINO FAIL")
            self.conectado = False
            return False
    ...
    def SEND_TO_ARDUINO(self, msg=0):
        try:
            if self.arduino.is_open:
                ...
                # Enviamos mensaje
                st = b""
                st += struct.pack("!B", msg)
                self.arduino.write(st)

                # Recibimos mensaje del arduino

                msg_control = int(self.arduino.readline().decode("ascii"))
